...
export class VmUsageLoggingSessionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getVmUsageReport(reportStart?: string, reportEnd?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<Array<VmUsageReport>>;
    public getVmUsageReport(reportStart?: string, reportEnd?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpResponse<Array<VmUsageReport>>>;
    public getVmUsageReport(reportStart?: string, reportEnd?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<HttpEvent<Array<VmUsageReport>>>;
    public getVmUsageReport(reportStart?: string, reportEnd?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json'}): Observable<any> {
